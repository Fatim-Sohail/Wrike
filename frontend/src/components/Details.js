...
const Details = () => {
  return (
    <div className="flex flex-col lg:flex-row">
      {/* Left half */}
      <div className="w-full lg:w-1/2 lg:ml-14 mt-12 p-8 lg:p-24 pr-4 text-left" style={{ fontFamily: 'Poppins, sans-serif' }}>
        ...
        <div className="mb-8">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="text-lg lg:text-xl text-gray-700 font-semibold mb-4">OUR OFFICE ADDRESS:</h3>
              <p className="text-xl lg:text-2xl text-gray-600">5109 Hollyridge Dr, Ste 102 Raleigh, NC 27612</p>
            </div>
          </div>
          ...
          <div className="flex items-start mt-6 lg:mt-8">
            ...
            <div>
              <h3 className="text-lg lg:text-xl text-gray-700 font-semibold mb-4">CALL US</h3>
              <p className="text-xl lg:text-2xl text-gray-600">+1 (919) 610-7760</p>
            </div>
          </div>
          ...
          <div className="flex items-start mt-6 lg:mt-8">
            ...
            <div>
              <h3 className="text-lg lg:text-xl text-gray-700 font-semibold mb-4">MAIL US:</h3>
              <p className="text-xl lg:text-2xl text-gray-600">info@company.com</p>
            </div>
          </div>
        </div>
      </div>
